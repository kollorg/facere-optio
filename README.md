...
[![CI](https://github.com/kollorg/facere-optio/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/kollorg/facere-optio/actions)
[![NPM ver](https://img.shields.io/npm/v/@kollorg/facere-optio?color=33cd56&logo=npm)](https://www.npmjs.com/package/@kollorg/facere-optio)
[![install size](https://packagephobia.com/badge?p=@kollorg/facere-optio)](https://packagephobia.com/result?p=@kollorg/facere-optio)
[![deps](https://img.shields.io/librariesio/release/npm/@kollorg/facere-optio)](https://libraries.io/npm/@kollorg/facere-optio)
![LoC](https://tokei.rs/b1/github/gnabgib/@kollorg/facere-optio-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@kollorg/facere-optio) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@kollorg/facere-optio-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@kollorg/facere-optio). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @kollorg/facere-optio --ignore-scripts
```
